...
func (s *SphericalPolygonShape) Boundary(nSegments int, closedRing bool) SphericalPolygon {
...
func (s *SphericalPolygonShape) Area() float64 {
	if s.area != nil {
		return *s.area
	}
	area := s.computeArea()
...
func (s *SphericalPolygonShape) GetBoundary(nSegments int, closedRing bool) SphericalPolygon {
	return s.Boundary(nSegments, closedRing)
}
